      ...
      <div className="container mx-auto max-w-6xl px-6">
        ...
        <div className="mb-20 grid grid-cols-1 gap-8 md:grid-cols-3">
          {communityImpactContent.stats.map((stat, index) => (
            ...
            >
              <div className="absolute top-0 right-0 h-32 w-32 bg-gradient-to-br from-green-400/10 to-blue-400/10 rounded-full -mr-16 -mt-16 transition-transform duration-300 group-hover:scale-150" />
              <div className="relative">
                <div className="mb-3 text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-blue-600">
                  {stat.value}
                </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            {communityImpactContent.programs.map((program, index) => (
              ...
              >
                {/* Icon Container */}
                <div className="mb-6 inline-flex items-center justify-center rounded-full bg-gradient-to-br from-green-500 to-blue-500 p-4 text-white transition-transform duration-300 group-hover:scale-110 group-hover:rotate-6">
                ...
                {/* Decorative element */}
                <div className="absolute bottom-0 left-0 h-1 w-0 bg-gradient-to-r from-green-500 to-blue-500 transition-all duration-300 group-hover:w-full" />
              </div>
            ))}
          </div>
        </div>
